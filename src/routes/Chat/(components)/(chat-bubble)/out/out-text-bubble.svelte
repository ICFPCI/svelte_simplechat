...
<div class="flex justify-end items-start gap-2.5">
	<div class="flex w-full max-w-[420px] flex-col gap-1 py-3 ">
		...
		<div
			class="leading-1.5 flex flex-col rounded-l-xl rounded-br-xl border-gray-200 bg-blue-100 p-4 dark:bg-blue-600"
		>
			<p class="break-words text-sm font-normal text-gray-900 dark:text-white">
				{text}
			</p>
		</div>
		<span class="text-sm text-end font-normal text-gray-500 dark:text-gray-400 ">{status}</span>
	</div>
</div>
